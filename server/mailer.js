...
export async function sendOrderPaidEmails(order) {
  ...
  const clientText = [
    ...
    "",
    "Ваш заказ Ishine успешно оплачен.",
    `Номер заказа: ${orderId}`,
    `Сумма: ${amount} ₽`,
    `Пункт выдачи: ${pickupAddress || "не указан"}`,
    "",
    "Срок изготовления заказа: от 2 до 14 дней.",
    "",
    "Когда зеркало будет готово и отправлено, на указанный номер телефона придёт СМС с информацией о доставке.",
    "",
    "По всем вопросам пишите в Instagram: @ishine_mag",
